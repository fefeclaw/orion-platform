  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <motion.p
        ...
        className="text-xs font-light tracking-[0.3em] text-[#D4AF37]/80 uppercase"
      >
        Orion Logistics
      </motion.p>
      ...
      <div
        ...
        style={{ height: "7rem", width: "100%", overflow: "hidden" }}
      >
        <AnimatePresence mode="wait">
          <motion.h1
            ...
            className="absolute whitespace-nowrap text-7xl md:text-8xl font-thin select-none uppercase text-shimmer"
            style={{
              letterSpacing: isCJK ? "0.05em" : "0.18em",
            }}
          >
            {current.text}
          </motion.h1>
