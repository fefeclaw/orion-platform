...
const MOCK_VESSELS: Vessel[] = [
  ...
  { id:"v41", name:"San Pedro Trader",      imo:"9090112", mmsi:"619000041", type:"Vraquier",         flag:"CI", cargoType:"bulk",      lat:4.7480,  lng:-6.6340, speed:0,    heading:0,   status:"berth",   destination:"Port de San Pedro",     eta:"À quai",          cargo:"Bois + Caoutchouc 25 000T",   tonnage:25000, approachIn24h:false, lastUpdate:new Date().toLocaleTimeString("fr-FR",{hour:"2-digit",minute:"2-digit"}) },
